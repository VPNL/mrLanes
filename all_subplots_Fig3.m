...
% This code was run to produce all subplots in Fig 3 and save them as .tif
...
% This produces plot 3a,e, by plotting pairwise fibers
for networks=1:2
    s=11
...
roifg=plotFibersDC(pairwiseFibers,ROIfgname,1); %loads in all pairwise fibers
...
% This produces plot 3b,f, by calcualting the DCs for all pairwise
