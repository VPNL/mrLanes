...
for tract=1:3
    ...
    if tract ==1
        pairwiseTracts={'lh_IFG2ISMGread_lmax8_select100_iFOD1_ang13_classified_clean.mat'...
            'lh_IPCS2ISMGmath_lmax8_select100_iFOD1_ang13_classified_clean.mat'};
    ...
    elseif tract ==2
             pairwiseTracts={'lh_IFG2STS_lmax8_select100_iFOD1_ang13_classified_clean.mat'...
            'lh_IPCS2ITG_lmax8_select100_iFOD1_ang13_classified_clean.mat'};
    ...
    elseif tract ==3 % math
        pairwiseTracts={'lh_IFG2inters_lmax8_select100_iFOD1_ang13_classified_clean.mat'...
            'lh_IPCS2inters_lmax8_select100_iFOD1_ang13_classified_clean.mat'};
        num=19;
        subjects=1:20
    ...
    output_roifg(1)=fg(num);
    load(pairwiseTracts{2});
    output_roifg(2)=fg(num);
...
%     close all;
    ...
    if tract==1
        outname=strcat('FigS19_distance_SLF.tif');
    elseif tract==2
        outname=strcat('FigS19_distance_AF.tif');
   elseif tract==3
        outname=strcat('FigS19_distance_AF_Intersection.tif');
    end
