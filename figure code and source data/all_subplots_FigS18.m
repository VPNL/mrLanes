...
for tract=1:3
    ...
    s=5 %the representative subject presented in manuscript
    if tract ==1
        pairwiseTracts={'lh_ISMG_morphing_reading_vs_all_sphere_7mm_lh_IFG_union_morphing_reading_vs_all_sphere_7mm_r1.00_WholeBrainFGRoiSeSph_classified_clean_overlap_unique.mat'...
            'lh_ISMG_morphing_adding_vs_all_sphere_7mm_lh_IPCS_morphing_adding_vs_all_sphere_7mm_r1.00_WholeBrainFGRoiSeSph_classified_clean_overlap_unique.mat'};
        outname=strcat('FigS15_fibers_SLF.tif');
        subjects=1:20
        num=15; %refers to the numerical code used in AFQ to label differenct fascicles, 15=left SLF
    elseif tract ==2
        pairwiseTracts={'lh_pSTS_MTG_union_morphing_reading_vs_all_sphere_7mm_lh_IFG_union_morphing_reading_vs_all_sphere_7mm_r1.00_WholeBrainFGRoiSeSph_classified_clean_overlap_unique.mat'...
            'lh_ITG_morphing_adding_sphere_7mm_lh_IPCS_morphing_adding_vs_all_sphere_7mm_r1.00_WholeBrainFGRoiSeSph_classified_clean_overlap_unique.mat'};
        outname=strcat('FigS15_fibers_AF.tif');
        subjects=1:20
        num=19;  %refers to the numerical code used in AFQ to label differenct fascicles, 19=left arcuate
        
    elseif tract ==3 % math
        pairwiseTracts={'lh_ITG_intersection_math_reading_sphere_7mm_lh_IFG_union_morphing_reading_vs_all_sphere_7mm_r1.00_WholeBrainFGRoiSeSph_classified_clean_overlap_unique.mat'...
            'lh_ITG_intersection_math_reading_sphere_7mm_lh_IPCS_morphing_adding_vs_all_sphere_7mm_r1.00_WholeBrainFGRoiSeSph_classified_clean_overlap_unique.mat'};
        num=19;
        subjects=1:20
        outname=strcat('FigS15_fibers_AF_Intersection.tif');
    end
    ...
    elseif tract==3
        ...
        ROIfg=['lh_ITG_Inter_IPCS_IFG_AF_overlap.mat'];
    end
...
%     
%     if tract==1
%         outname=strcat('FigS15_decoding_SLF.tif');
%     elseif tract==2
%         outname=strcat('FigS15_decoding_AF.tif');
%     elseif tract==3
%         outname=strcat('FigS15_decoding_AF_intersection.tif');
%     end
%     
