...
% ROIs
ROIs={'lh_OTS_union_morphing_reading_vs_all_projed_gmwmi' 'lh_pSTS_MTG_union_morphing_reading_vs_all_projed_gmwmi' 'lh_ISMG_morphing_reading_vs_all_projed_gmwmi' 'lh_IFG_union_morphing_reading_vs_all_projed_gmwmi'...
    'lh_ITG_morphing_adding_projed_gmwmi' 'lh_pIPS_morphing_adding_vs_all_projed_gmwmi' 'lh_ISMG_morphing_adding_vs_all_projed_gmwmi' 'lh_IPCS_morphing_adding_vs_all_projed_gmwmi'...
    'lh_Ac_Cc_Pc_union_morphing_color_vs_all_projed_gmwmi' 'lh_ITG_intersection_math_reading_projed_gmwmi'}
...
%     'lh_Ac_Cc_Pc_union_morphing_color_vs_all_sphere_7mm' 'lh_ITG_intersection_math_reading_sphere_7mm'}
...
fatRenderFibersForPublication(ExpDir, '13_cb_dti_mrTrix3_081317', '96dir_run1/fw_afq_ET_ACT_LiFE_3.0.2_lmax8', ROIfgname,fibersToPlot,t1name,'lh',colors)
cd(OutDir);
...
scatters=1;
[fig] = plotFiberCountPercentClassified(percentage,hem, scatters);
cd(OutDir);
