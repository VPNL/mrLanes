...
function [percentage]=fiberCountFibersInRoiClassified(sessid, fatDir, ROI, ROIfgname, OutDir,hem)
...
if hem==1 
for_lines=(percentage(subjcnt,[12 14 16 20 22 28])/10);
elseif hem==2 
for_lines=(percentage(subjcnt,[13 15 17 21 23 29])/10);
end
