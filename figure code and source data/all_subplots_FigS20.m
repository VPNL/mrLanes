...
%  % the results
if tract==1
    outname=strcat('FigS20_tract_SLF.tif');
elseif tract==2
     outname=strcat('FigS20_tract_AF.tif');
elseif tract==3
     outname=strcat('FigS20_tract_AF_Intersection.tif');
end
...
if tract==1
    outname=strcat('FigS20_mean_SLF.tif');
elseif tract==2
     outname=strcat('FigS20_mean_AF.tif');
elseif tract==3
     outname=strcat('FigS20_mean_AF_Intersection.tif');
end
print(gcf, '-dtiff', outname,'-r600')
...
if tract==1
    outname=strcat('FigS20_histo_SLF.tif');
elseif tract==2
     outname=strcat('FigS20_histo_AF.tif');
elseif tract==3
     outname=strcat('FigS20_histo_AF_Intersection.tif');
end
print(gcf, '-dtiff', outname,'-r600')
close all;
 end
