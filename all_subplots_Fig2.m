...
% This code was run to produce all subplots in Fig 2 and save them as .tif
...
% This procuces the plots in the left column of Fig 2, by plotting the functional white matter tracts of each ROI in a representative subject 
