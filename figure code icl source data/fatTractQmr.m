...
if exist(fgFile,'file')
    ...
    % Compute a Tract t1
    [T1, md, rd, ad, cl, volume, TractProfile, SuperFiber, fgResampled]  = AFQ_ComputeTractProperties(roifg,t1, numNodes, clip2rois, runDir,weighting,[],num);
    ...
    % Compute a Tract tv
     [TV, md, rd, ad, cl, volume, TractProfile, SuperFiber, fgResampled] = AFQ_ComputeTractProperties(roifg, tv, numNodes, clip2rois, runDir,weighting,[],num);
