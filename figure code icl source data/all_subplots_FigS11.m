...
ROIfgname=strcat(ROIs{r}, '_r1.00_WholeBrainFGRoiSeSph_classified_clean.mat')
...
cd(OutDir);
outname=strcat('FigS11_fibers_',ROIs{r},'.tif');
...
cd(OutDir);
outname=strcat('FigS11_bar_graph_',ROIs{r},'.tif');
print(gcf, '-dtiff', outname,'-r600')
end
