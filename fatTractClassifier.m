...
function [fig,accuracy,accuracyMean,accuracySE]=fatTractClassifier(ExpDir,sessid,qmrSessid,fgName,num)
...
for s=1:size(fgResampledMath,1)
    counter=0
    for trainingNode=1:1:29   % train SVN classifier
        ...
        % test SVM Classifier
        SVMModel = fitcsvm(bothCoords,bothNames,'Standardize',true,'KernelFunction','polynomial',...
