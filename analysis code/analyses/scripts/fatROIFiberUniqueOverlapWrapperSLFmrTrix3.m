...
for r=1:length(runName)
    %
    % fgName='run1_lmax8_curvatures_concatenated_optimize_it500_new_classified_clean'
    ...
    % fgName='run1_lmax8_curvatures_concatenated_optimize_it500_new_classified_clean_AF_overlap'
    ...
    %
    roiName={'lh_ISMG_morphing_reading_vs_all_sphere_7mm_lh_IFG_union_morphing_reading_vs_all_sphere_7mm' 'lh_ISMG_morphing_adding_vs_all_sphere_7mm_lh_IPCS_morphing_adding_vs_all_sphere_7mm'}
    ...
    for s=1:20
        ...
        if (exist(roifgFile1,'file')>0 && exist(roifgFile2,'file')>0)
            ...
            fib(s,:)=fiberCount;
               ...
               roiName={'lh_ISMG_morphing_adding_vs_all_sphere_7mm_lh_IPCS_morphing_adding_vs_all_sphere_7mm' 'lh_ISMG_morphing_reading_vs_all_sphere_7mm_lh_IFG_union_morphing_reading_vs_all_sphere_7mm'}
            fiberCount = fatRoiFiberUnique(fatDir, sessid(s), runName(r), fgName, roiName, foi, '1.00')
