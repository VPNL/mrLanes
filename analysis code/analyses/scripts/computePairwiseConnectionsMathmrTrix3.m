...
% roiName={'lh_IPCS_morphing_adding_vs_all_r5.00_lh_ISMG_morphing_adding_vs_all'...
%     'lh_IFG_union_morphing_reading_vs_all_r5.00_lh_ISMG_morphing_reading_vs_all'...
%     'lh_IFG_union_morphing_reading_vs_all_r5.00_lh_ISMG_morphing_adding_vs_all'}
% foi=1:28
% 
% fiberCount = fatRoiFiberUnique(fatDir, sessid, runName, fgName, roiName, foi, '5.00')