...
ROIs={'lh_OTS_union_morphing_reading_vs_all_projed_gmwmi.mat' 'lh_IFG_union_morphing_reading_vs_all_projed_gmwmi.mat'... 
    'lh_pSTS_MTG_union_morphing_reading_vs_all_projed_gmwmi.mat' 'lh_ISMG_morphing_reading_vs_all_projed_gmwmi.mat'... 
    'lh_ITG_morphing_adding_projed_gmwmi.mat' 'lh_pIPS_morphing_adding_vs_all_projed_gmwmi.mat'...  
    'lh_IPCS_morphing_adding_vs_all_projed_gmwmi.mat' 'lh_ISMG_morphing_adding_vs_all_projed_gmwmi.mat'... 
    'lh_Ac_Cc_Pc_union_morphing_color_vs_all_projed_gmwmi.mat' 'lh_ITG_intersection_math_reading_projed_gmwmi.mat'...
    'rh_OTS_union_morphing_reading_vs_all_projed_gmwmi.mat' 'rh_IFG_union_morphing_reading_vs_all_projed_gmwmi.mat'... 
    'rh_pSTS_MTG_union_morphing_reading_vs_all_projed_gmwmi.mat' 'rh_ISMG_morphing_reading_vs_all_projed_gmwmi.mat'... 
    'rh_ITG_morphing_adding_projed_gmwmi.mat' 'rh_pIPS_morphing_adding_vs_all_projed_gmwmi.mat'...  
    'rh_IPCS_morphing_adding_vs_all_projed_gmwmi.mat' 'rh_ISMG_morphing_adding_vs_all_projed_gmwmi.mat'... 
    'rh_Ac_Cc_Pc_union_morphing_color_vs_all_projed_gmwmi.mat' 'rh_ITG_intersection_math_reading_projed_gmwmi.mat'};
...
% parameters, and concat them
 for r=1:length(runName)
fatCreateEtConnectomeMRtrix3ROIIFOD1(fatDir, fsDir, sessid{s}, anatid{s}, runName{r});
 end
%  
...
for r=1:length(runName)
    ...
    fgName=['WholeBrainFGRoiSe_classified_clean.mat']
...
for r=1
    for n=1
        ...
        ROIfg=['WholeBrainFGRoiSe_classified_clean.mat'];
        if n<5
            hem='lh'
            foi=[11 13 15 19 27 21];
        else
