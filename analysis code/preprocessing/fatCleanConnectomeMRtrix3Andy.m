function fatCleanConnectomeMRtrix3Andy(fatDir, anatDir, anatid, sessid, runName, fgName, rmOutlier)
...
if rmOutlier
    %[1:4 7:12 17:18 23:28]
    %[9 10 15 16 19 20]
    for ii = [15 16 19 20 21 22]
        try
        if ii==11
        ...
        maxDist = 2.5; maxLen = 2.5; numNodes = 100; M = 'mean'; maxIter = 200; count = true; show=false;
